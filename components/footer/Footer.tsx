...
export const Footer = () => {
  return (
    <article className="fixed bottom-1/4 p-6 left-1/2 -translate-x-1/2">
      <div className=" bg-accent-foreground/80 px-4 py-3 rounded-lg">
        <h3 className="text-xl text-background font-bold text-center mb-3">
          Síguenos en:
        </h3>
